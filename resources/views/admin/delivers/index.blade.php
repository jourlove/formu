        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Delivers</div>
                    <div class="panel-body">
                        <a href="{{ url('/admin/delivers/create') }}" class="btn btn-success btn-sm" title="Add New Deliver">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/delivers', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $delivers->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
